...
test_point = np.array([[2.9, 2, 4.9, -48.333]])
...
wifi_distribution_data = pd.read_csv("wifi_signal_data_5.csv")  # 你要换成实际路径
...
# 显示结果
o3d.visualization.draw_geometries([ obstacle_pcd], window_name="3d environment reconstruct")
